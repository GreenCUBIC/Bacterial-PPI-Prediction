...
parser.add_argument('-m', '--momentum', help='Momentum (float)', type=float, default=0.9)
parser.add_argument('-d', '--decay', help='Decay (float)', type=float, default=0.001)
parser.add_argument('-learning_rate', '--learning_rate', help='Learning rate (float)', type=float, default=0.01)
...
if __name__ == "__main__": 
    ...
    if not CROSS_VALIDATE:
        ...
        if pretrained == None:
            ...
            sgd = SGD(lr=args.learning_rate, momentum=args.momentum, decay=args.decay)
